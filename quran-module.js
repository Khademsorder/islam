...
const IslamicModule = (function () {
  ...
  const HADITH_TOPICS = [
    ...
    { id: 'tibb', name: 'চিকিৎসা ও রোগ', keywords: ['রোগ', 'চিকিৎসা', 'ঔষধ', 'ঝাড়ফুঁক', 'রুকইয়াহ', 'মৃত্যু', 'জানাযা', 'কবর'] },
  ...
  async function initDB() {
    return new Promise((resolve, reject) => {
      const req = indexedDB.open(DB_NAME, 3); // Version 3 for hadith topics store
